...
.intelligence-flow-grid {
    display:grid;
    grid-template-columns:minmax(0,1.25fr) minmax(210px,.45fr) minmax(320px,.65fr);
    gap:8px;
    margin-top:8px;
}
...
.strat-setup-card {
    background:
        radial-gradient(circle at 100% 0%, rgba(139,61,255,.12), transparent 44%),
        #090d12;
...
.strat-progress-fill {
    height:100%;
    border-radius:999px;
    background:linear-gradient(90deg,#73f6a7,#8b3dff);
}
...
summary_html = (
    ...
    f"<div class='strat-setup-card'>"
    f"<div class='strat-setup-title'>7C EXECUTION SETUP</div>"

    f"<div class='strat-label'>SETUP</div>"
    f"<div class='strat-main {trade_class}'>BULL 2-1-2 CONTINUATION</div>"

    f"<div class='strat-label'>TIMEFRAME</div>"
    f"<div class='strat-row'><span>D</span><span class='green'>● 2U</span></div>"
    f"<div class='strat-row'><span>4H</span><span class='green'>● 2U</span></div>"
    f"<div class='strat-row'><span>1H</span><span class='yellow'>● 1</span></div>"
    f"<div class='strat-row'><span>15m</span><span class='green'>● 2-1-2</span></div>"

    f"<div class='strat-alignment-head'><span>ALIGNMENT</span><span>80%</span></div>"
    f"<div class='strat-progress'>"
    f"<div class='strat-progress-fill' style='width:80%'></div>"
    f"</div>"

    f"<div class='strat-level-grid'>"
    f"<div class='strat-level'>"
    f"<div class='strat-level-label'>TRIGGER</div>"
    f"<div class='strat-level-value green'>{bull_entry}</div>"
    f"</div>"
    f"<div class='strat-level'>"
    f"<div class='strat-level-label'>FAIL BELOW</div>"
    f"<div class='strat-level-value red'>{bear_entry}</div>"
    f"</div>"
    f"</div>"
    f"</div>"
